...
For detailed installation instructions, please refer to the [full installation guide](/oss/installation/overview).
...
For a full list of available requests, please check the [API Reference](/oss/api/overview).
