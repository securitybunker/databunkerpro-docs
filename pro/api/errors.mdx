...
| `Record limit reached` | The [license record cap](/pro/get-started/licensing#when-the-record-cap-is-reached) was hit — new records cannot be created, while reads, updates and deletes keep working |
| `License expired` | The installation license has expired and the vault is [read-only](/pro/get-started/licensing#when-the-license-expires) — reads, exports and deletions still work |
