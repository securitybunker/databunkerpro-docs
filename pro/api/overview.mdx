...
## Using this API with AI Assistants

You can feed the full Databunker Pro API specification directly into your LLM or AI coding assistant to get accurate, context-aware help when building integrations.

**OpenAPI specification (machine-readable):**
```
https://docs.databunker.org/pro/api/openapi.yml
```

**Full documentation in LLM-friendly format:**
```
https://docs.databunker.org/llms-full.txt
```

Copy either URL and paste it into ChatGPT, Claude, Cursor, or any other AI tool that accepts URL or file context. The OpenAPI spec is the most precise source for endpoint details, request/response schemas, and authentication requirements.
