...
<Note>
This page covers applying a key. For what a license controls — record caps, what counts as a record, how many licenses a deployment needs, and what happens at the cap or at expiry — see [Licensing and limits](/pro/get-started/licensing).
</Note>
...
- A valid license key. Request or renew one in the [Databunker Portal](https://portal.databunker.org), then fetch it from there once it is approved.
