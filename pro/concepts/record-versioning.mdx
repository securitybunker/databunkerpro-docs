...
<Note>
Versions are included in the record they belong to and do not count separately against your license. Enabling versioning never multiplies your record count — see [Licensing and limits](/pro/get-started/licensing#what-counts-as-a-record).
</Note>
...
- [Licensing and limits](/pro/get-started/licensing#what-counts-as-a-record) — versions travel with the record and do not count separately
- [Backup and recovery](/pro/administration/backup-and-recovery) — versioning is not a backup
- [Access control](/pro/administration/access-control) — restricting who can read or restore a version