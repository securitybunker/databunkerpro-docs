...
- [PII vault](/pro/get-started/pii-vault) — the user record a file is attached to
- [Access control](/pro/administration/access-control) — who may upload, list, and download
- [Backup and recovery](/pro/administration/backup-and-recovery) — files are covered by the same key model
