...
- **Audited on every call**, including the `request_metadata` provided by the caller (see [Access control](/pro/administration/access-control)).
...
curl -X POST https://your-databunker-instance/v2/SystemGetUserProfiles \
  ...
  -d "{
    ...
    \"unlockuuid\": \"$UNLOCK\",
    \"request_metadata\": {
      \"purpose\": \"dsar-fulfillment\",
      \"ticket_id\": \"DSAR-2026-001\"
    }
  }"
```
