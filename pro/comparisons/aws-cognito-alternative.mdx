...
For the full procedure — export script, attribute mapping, verification, and rollback — see [Migrate from AWS Cognito](/pro/migrations/aws-cognito).
...
- [Migrate from AWS Cognito](/pro/migrations/aws-cognito) — export the pool, import into the vault, cut over authentication
- [Quickstart](/pro/get-started/quickstart) — a running vault and a first API call from one `docker run`
- [Licensing and limits](/pro/get-started/licensing) — what a record is, and what the licence caps
