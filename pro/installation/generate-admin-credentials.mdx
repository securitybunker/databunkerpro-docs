...
- **Trial license key** — create a free trial account at [portal.databunker.org/trial](https://portal.databunker.org/trial) and generate a key that covers up to **1 million records**.
...
<Note>
Trial mode expires 14 days after setup, after which the vault becomes read-only. For a longer evaluation use a trial key. See [Licensing and limits](/pro/get-started/licensing) for record caps, expiry behaviour, and how many licenses a deployment needs.
</Note>
