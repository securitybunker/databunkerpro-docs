...
- **Leave it empty** — Databunker Pro runs in Trial mode, limited to **1,000 records**, which is enough to evaluate it.
- **Paid license key** — [book a call](https://cal.com/databunker-team/30min) to purchase one.
