...
Databunker Pro is now running and ready to use. Next, learn how to issue scoped credentials in the [Authentication reference](/pro/api/authentication) — and before going live, work through the [production checklist](/pro/installation/production-checklist).
