...
Yes. Databunker Pro is built in Go on a stateless, horizontally-scalable architecture. A recent internal benchmark on a single AWS EC2 `m6i.2xlarge` (5,000,000 records, 120-field user profiles, co-located PostgreSQL) sustained **~1,700 records/sec** on bulk writes with linear scaling from 1 M to 5 M records.
