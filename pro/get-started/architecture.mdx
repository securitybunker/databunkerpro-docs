---
title: Architecture
description: How Databunker Pro is put together — backend storage options, the two-layer encryption and key management model, deployment and scaling topology, and the tokenization paths for user records and payment data.
---
...
<img src="/pro/get-started/databunker-diagram.png" alt="Architecture diagram" style={{ backgroundColor: '#FFF'}} className="rounded-lg" />
...
- [Security overview](/pro/get-started/security-overview) — the control set behind this architecture
- [Performance and sizing](/pro/get-started/performance) — measured throughput and how to size each tier
- [Quickstart](/pro/get-started/quickstart) — try the API against a throwaway instance first
- [Installation](/pro/installation/docker-compose) — deploy with Docker Compose or Kubernetes
