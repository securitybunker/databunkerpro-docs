...
- [Licensing and limits](/pro/get-started/licensing) — confirm your record cap covers the count you just sized for
- [Production checklist](/pro/installation/production-checklist) — the go-live gate
- [Migrate a SQL users table](/pro/migrations/sql-users-table) — bulk-load an existing table at these rates
